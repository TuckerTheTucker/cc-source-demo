...
class FreeplayState extends MusicBeatState
{
	...
	{
		if (TitleState.cheatActive)
		cheatActive = true;
		
		var initSonglistS = CoolUtil.coolTextFile(Paths.txt('freeplaySonglistSecret'));
			
		var initSonglist = CoolUtil.coolTextFile(Paths.txt('freeplaySonglist'));
			
		if (cheatActive)
		{
			initSonglist = initSonglistS;
			trace ("Enjoy your new songs lol");
		}
