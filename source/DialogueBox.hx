...
class DialogueBox extends FlxSpriteGroup
{
	...
	public function new(talkingRight:Bool = true, ?dialogueList:Array<String>)
	{
		...
		else if (PlayState.SONG.song.toLowerCase() == 'snicker')
		{
		...
		dropText = new FlxText(127, 482, Std.int(FlxG.width * 0.6), "", 42);
		dropText.font = 'Pixel Arial 11 Bold';
		add(dropText);

		swagDialogue = new FlxTypeText(125, 480, Std.int(FlxG.width * 0.6), "", 42);
	...
	override function update(elapsed:Float)
	{
		...
		if (isPepper)
		{
			swagDialogue.font = 'MV Boli';
			swagDialogue.color = 0xFF140F00;
			swagDialogue.sounds = [FlxG.sound.load(Paths.sound('pepperText', 'shared'), 0.6)];
