...
class MainMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var versionShit:FlxText = new FlxText(5, FlxG.height - 18, 0, "CC DEMO - Made By TuckerTheTucker", 12);
	...
	override function update(elapsed:Float)
	{
		...
		if (!selectedSomethin && !isExiting)
		{
			...
			if (FlxG.keys.justPressed.ESCAPE) //to differentiate backspace and escape
			{
